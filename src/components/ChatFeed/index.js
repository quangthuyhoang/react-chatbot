...
var ChatFeed = function (_React$Component) {
    ...
    _createClass(ChatFeed, [{
        ...
        value: function render() {
            ...
            return React.createElement("div", { id: "chat-panel", style: Object.assign({}, styles_1.default.chatPanel, {maxHeight: maxHeight, minHeight: minHeight}) }, React.createElement("div", { ref: function ref(c) {
                    _this2.chat = c;
                }, className: "chat-history", style: Object.assign({}, styles_1.default.chatHistory, {maxHeight: maxHeight, minHeight: minHeight}) }, React.createElement("div", { className: "chat-messages" }, this.renderMessages(this.props.messages))), inputField);
        }
    }]);
